...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/s2.jpeg') }}" alt="Product Image" class="product-image" id="productImage">

        <!-- Centered Text -->
        <p class="product-title">Harmony in Flight</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Harmony in Flight">
            ...
            <input type="hidden" name="product_image" value="s2.jpeg">
