...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/l4.jpeg') }}" alt="Product Image" class="product-image" id="productImage" style="height:300px;">

        <!-- Centered Text -->
        <p class="product-title">Bonsai Tree Lamp</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Bonsai Tree Lamp">
            ...
            <input type="hidden" name="product_image" value="l4.jpeg">
