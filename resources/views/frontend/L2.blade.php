...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/l2 (2).jpeg') }}" alt="Product Image" class="product-image" id="productImage" style="height:300px;">

        <!-- Centered Text -->
        <p class="product-title">Tree of Light Lamp</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Tree of Light Lamp">
            ...
            <input type="hidden" name="product_image" value="l2 (2).jpeg">
