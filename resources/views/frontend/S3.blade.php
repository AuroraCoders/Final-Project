...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/s3.jpeg') }}" alt="Product Image" class="product-image" id="productImage">

        <!-- Centered Text -->
        <p class="product-title">Expressions of Creativity</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Expressions of Creativity">
            ...
            <input type="hidden" name="product_image" value="s3.jpeg">
