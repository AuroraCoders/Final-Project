...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/s6.jpeg') }}" alt="Product Image" class="product-image" id="productImage" style="height:300px;">

        <!-- Centered Text -->
        <p class="product-title">Eternal Circles</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Eternal Circles">
            ...
            <input type="hidden" name="product_image" value="s6.jpeg">
