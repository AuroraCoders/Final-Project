...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/f4.jpeg') }}" alt="Product Image" class="product-image" id="productImage" style="height:300px;">

        <!-- Centered Text -->
        <p class="product-title">Wooden Side Table</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Wooden Side Table">
            ...
            <input type="hidden" name="product_image" value="f4.jpeg">
