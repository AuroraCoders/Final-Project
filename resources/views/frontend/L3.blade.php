...
<br>
    ...
    <div class="container product-container">
        <!-- Centered Image -->
        <img src="{{ asset('images/l3.jpeg') }}" alt="Product Image" class="product-image" id="productImage" style="height:300px;">

        <!-- Centered Text -->
        <p class="product-title">Cyclic Wheel Lamp</p>
        ...
        <form action="{{ route('addToCart') }}" method="POST">
            @csrf
            <input type="hidden" name="product_name" value="Cyclic Wheel Lamp">
            ...
            <input type="hidden" name="product_image" value="l3.jpeg">
